...
const Form: NextComponentType = () => {
    ...
    return (
        <form onSubmit={handleSubmit}>
            ...
            <label className="block mt-2">
                <button type="submit" className="block w-full px-3 py-2 border bg-purple-500 hover:bg-purple-700 rounded-md shadow-sm text-sm leading-5 text-white font-semibold">Login</button>
            </label>
            <label className="block mt-2">
            ...
            <label className="block mt-2">
                <button className="block w-full py-2 text-sm leading-5 text-purple-500 hover:text-purple-700 font-semibold">Forgot Password</button>
            </label>
        </form>
    );
}
